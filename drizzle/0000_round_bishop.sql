...
CREATE TABLE IF NOT EXISTS "ChatCollection" (
	...
	CONSTRAINT "ChatCollection_chatId_collectionId_pk" PRIMARY KEY("chatId","collectionId")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "Message_v2" (
	...
	"parts" json NOT NULL,
	"tool_calls" json DEFAULT 'null'::json,
	"attachments" json NOT NULL,
	"memories" jsonb DEFAULT 'null'::jsonb,
	"modelId" varchar,
	"createdAt" timestamp NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "MessageMemory" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "User" (
	...
	"subscriptionUpdatedAt" timestamp DEFAULT now()
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ChatCollection" ADD CONSTRAINT "ChatCollection_chatId_Chat_id_fk" FOREIGN KEY ("chatId") REFERENCES "public"."Chat"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ChatCollection" ADD CONSTRAINT "ChatCollection_collectionId_Collection_id_fk" FOREIGN KEY ("collectionId") REFERENCES "public"."Collection"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Collection" ADD CONSTRAINT "Collection_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
